...
const _IsomorphicClerk = class _IsomorphicClerk {
  constructor(options) {
    ...
    this.setSession = (session, beforeEmit) => {
      (0, import_shared.deprecated)("setSession", "Use `Clerk.setActive` instead");
    ...
    this.handleMagicLinkVerification = async (params) => {
      (0, import_shared.deprecated)("handleMagicLinkVerification", "Use `handleEmailLinkVerification` instead.");
