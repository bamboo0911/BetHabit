...
export type OrganizationPermission = 'org:domains:manage' | 'org:domains:delete' | 'org:profile:manage' | 'org:profile:delete' | 'org:memberships:read' | 'org:memberships:manage' | 'org:memberships:delete' | 'org:domains:read';
